...
<div class="header">
		<div class="logo">
			<h1><a href="index.php"><img src="Rafi/logo1.png" alt=""></a></h1>
		</div>
	</div>
</div>
</div>
...
<div style="height:300px; width:600px; margin:auto; margin-top:60px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
<form method="post">
     <table cellpadding="0" cellspacing="0" width="500px" class="tableborder" style="margin:auto" >

        <tr><td colspan="2" align="center"><img src="Rafi/chpass2.png" height="70px" /></td></tr>
   
                <tr><td><img src="Rafi/chng.png" width="130px" height="130px" style= "margin-top:-20px" align="left"/></td>
